...
<rect class={stylus.cls} height="9.96" rx="2.5" width="4.99" x="15.25" y="3.61"/>

<path class={stylus.cls} d="M25.63,12.64A2.38,2.38,0,0,0,27.4,9c-.09-.12-.19-.23-.29-.34h0a2.34,2.34,0,0,0-.35-.29,2.37,2.37,0,0,0-3.63,1.77l.06,2.43Z"/>

<path class={stylus.cls} d="M20.24,25a2.39,2.39,0,0,0,3.64,1.78c.12-.09.23-.19.34-.29h0a3.17,3.17,0,0,0,.29-.35,2.38,2.38,0,0,0-1.77-3.63l-2.43.06Z"/>

<path class={stylus.cls} d="M7.54,20.16a2.37,2.37,0,0,0-1.77,3.63,1.87,1.87,0,0,0,.29.34h0a1.87,1.87,0,0,0,.34.29A2.37,2.37,0,0,0,10,22.65L10,20.22Z"/>

<path class={stylus.cls} d="M12.36,7.11A2.38,2.38,0,0,0,8.73,5.33c-.12.09-.23.19-.34.29h0A2.34,2.34,0,0,0,8.1,6,2.37,2.37,0,0,0,9.87,9.6l2.43-.06Z"/>

<rect class={stylus.cls} height="9.96" rx="2.5" width="4.99" x="12.48" y="18.48"/>

<rect class={stylus.cls} height="9.96" rx="2.5" transform="translate(41.61 -6.64) rotate(90)" width="4.99" x="21.62" y="12.5"/>

<rect class={stylus.cls} height="9.96" rx="2.5" transform="translate(23.73 5.55) rotate(90)" width="4.99" x="6.59" y="9.66"/>
...
export default component$(() => {
    ...
    return (
        ...
        <svg class={stylus.rotate} width="20" height="20" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M22.9049 26.6675C23.0274 26.6456 23.1368 26.5844 23.2199 26.4925L29.3274 20.4025L29.7124 20L29.3274 19.5975L23.2199 13.5075C23.0843 13.3413 22.8677 13.2647 22.6577 13.3128C22.4499 13.3609 22.2858 13.525 22.2377 13.7328C22.1896 13.9428 22.2662 14.1594 22.4324 14.295L27.5774 19.44L11.0399 19.44C10.8386 19.4378 10.6505 19.5428 10.5477 19.7178C10.4471 19.8928 10.4471 20.1072 10.5477 20.2822C10.6505 20.4572 10.8386 20.5622 11.0399 20.56L27.5774 20.56L22.4324 25.705C22.2508 25.8734 22.2027 26.1403 22.3121 26.3613C22.4193 26.5844 22.6621 26.7069 22.9049 26.6675Z" fill="#335C63"/>
</svg>
            Vancouver 
        </div>
...
Upcoming
 <span>
  ...
  Cancelled
            ...
            <div class={stylus.cartoon}>
            <div class={stylus.card}>
<div class={stylus.header}><h5>Information</h5></div>

            <span><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000" version="1.1" id="Capa_1" width="16" height="16" viewBox="0 0 395.71 395.71" xml:space="preserve">
<g>
	<path d="M197.849,0C122.131,0,60.531,61.609,60.531,137.329c0,72.887,124.591,243.177,129.896,250.388l4.951,6.738   c0.579,0.792,1.501,1.255,2.471,1.255c0.985,0,1.901-0.463,2.486-1.255l4.948-6.738c5.308-7.211,129.896-177.501,129.896-250.388   C335.179,61.609,273.569,0,197.849,0z M197.849,88.138c27.13,0,49.191,22.062,49.191,49.191c0,27.115-22.062,49.191-49.191,49.191   c-27.114,0-49.191-22.076-49.191-49.191C148.658,110.2,170.734,88.138,197.849,88.138z"/>
</g>
</svg>Vancouver,BC</span>
<div><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none">
<path d="M20.5 21C21.8807 21 23 19.8807 23 18.5C23 16.1726 21.0482 15.1988 19 14.7917M15 11C17.2091 11 19 9.20914 19 7C19 4.79086 17.2091 3 15 3M3.5 21.0001H14.5C15.8807 21.0001 17 19.8808 17 18.5001C17 14.4194 11 14.5001 9 14.5001C7 14.5001 1 14.4194 1 18.5001C1 19.8808 2.11929 21.0001 3.5 21.0001ZM13 7C13 9.20914 11.2091 11 9 11C6.79086 11 5 9.20914 5 7C5 4.79086 6.79086 3 9 3C11.2091 3 13 4.79086 13 7Z" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg> 1300 members</div>
            </div>
            <div class={stylus.card}>
            <h5>Next event</h5>
            </div>
            ...
            <div class={stylus.detail}>
                ...
                <div>
                    {community.groups?.map((g,i) => (
                        <a class={stylus.link} target="_blank" key={i} href={g.url}>{getIcon(g.type)}</a>
                        ))}
                </div>
            <div>
                Upcoming events
